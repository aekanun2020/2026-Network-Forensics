...
สำหรับคำตอบอ้างอิงตามโจทย์ปัจจุบัน เปิด [cross-check NF-01-v2](../CROSS-CHECK-NF-01-v2.md) และ [ผลอ่านไฟล์ใหม่โดยไม่เรียก MCP](nf-01-v2/README.md) ซึ่งเก็บแยกจากผลด้านล่าง
