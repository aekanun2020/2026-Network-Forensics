...
3. [คำตอบต่อโจทย์เดิม](AGENT-ANSWER.md) — คำตอบ Codex รอบเดิมที่ผู้ใช้ส่งมา เก็บไว้ตามประวัติ
4. [คำตอบ cross-check ตาม NF-01-v2](CROSS-CHECK-NF-01-v2.md) — Codex อ่าน local files ใหม่โดยไม่เรียก MCP พร้อม source inventory, claims และ records/packets
5. [ผลตรวจคำตอบเดิมและวิธีทำซ้ำ](verification/README.md)
