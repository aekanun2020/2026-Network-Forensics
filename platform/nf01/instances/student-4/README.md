...
MCP endpoint: `https://35-240-216-66.sslip.io/mcp`
...
Runtime directory: `/opt/nf01`. HTTPS uses fresh `student-4` TLS volumes. Copied source certificate/account volumes are retained but not mounted by HTTPS. Copied job history is retained and is not a new result for this group. Keep raw evidence and HDFS volumes when changing the hostname.
