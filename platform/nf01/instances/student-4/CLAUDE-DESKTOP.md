...
`https://35-240-216-66.sslip.io/mcp`

ชื่อ connector: **NF-01 student-4**
...
3. กรอกชื่อ **NF-01 student-4** และ URL ข้างต้น แล้วกด **Add**
4. เปิดแชตใหม่ กด **+ → Connectors** แล้วเปิดใช้งาน **NF-01 student-4**
...
> ใช้ connector NF-01 student-4 เรียก hdfs_stat และ hdfs_sha256 สำหรับไฟล์ /student/agentic-siem/incident-lab/input/coherent-pcap-zeek-dns-120.jsonl แล้วรายงานขนาดและ SHA-256 จากผลเครื่องมือจริง ยังไม่ต้องวิเคราะห์เหตุการณ์
...
[ผลทดสอบจากเครื่องภายนอก VM](https://github.com/aekanun2020/2026-Network-Forensics/blob/main/cloud-activities/evidence/2026-09-09-student-4-public-mcp-verification.json) เป็นการตรวจโดย MCP SDK จริง ไม่มีการเรียกโมเดล ไม่ใช่ผลทดสอบภายในบัญชี Claude Desktop ของผู้เรียน ต้องทดลองเชื่อมตามขั้นตอนข้างต้นก่อนเริ่มเรียน

URL ผูกกับ IP `35.240.216.66` ซึ่งยังไม่พบการจองเป็น Static IP ในการตรวจล่าสุด หาก IP เปลี่ยนต้องตั้งชื่อปลายทางและออกใบรับรองใหม่ก่อนแจก URL
